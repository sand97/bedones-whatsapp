...
const SWAGGER_FILE = path.join('..', 'backend', 'swagger-output', 'swagger.json');

// show if file exists
if (!fs.existsSync(SWAGGER_FILE)) {
  console.error('❌ Swagger file not found, please start backend once to generate Swagger JSON file', SWAGGER_FILE);
  process.exit(1);
}
